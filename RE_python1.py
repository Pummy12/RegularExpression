...
match_object = re.match(r'(\w+)@(\D+)(\d+)\.(\w+)', 'username@geekforgeeks2024.org')
...
# for the fourth parenthesized subgroup
print(match_object.group(4))

# for a tuple of all matched subgroups
print(match_object.group(1, 2, 3, 4))
